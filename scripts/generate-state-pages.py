...
<p style="font-size:13px"><a href="../states/" style="text-decoration:underline">All states</a> · <a href="../" style="text-decoration:underline">Home</a> · <a href="../privacy/" style="text-decoration:underline">Privacy</a> · <a href="../terms/" style="text-decoration:underline">Terms</a> · <a href="../refunds/" style="text-decoration:underline">Refund policy</a> · <a href="mailto:support@permitsclerk.com" style="text-decoration:underline">support@permitsclerk.com</a></p>
...
<script>
if(location.protocol==='file:'){{document.querySelectorAll('a').forEach(a=>{{const h=a.getAttribute('href');if(h==='../')a.setAttribute('href','../index.html');else if(h&&h.startsWith('../get-your-sales-permit/'))a.setAttribute('href','../get-your-sales-permit/index.html'+(h.includes('?')?h.slice(h.indexOf('?')):''));else if(h==='../states/')a.setAttribute('href','../states/index.html');else if(h&&h.startsWith('../')&&h.endsWith('/'))a.setAttribute('href',h+'index.html')}})}}
</script>
</body>
</html>
"""
...
def page_taxed(s):
    ...
    qas = [
        (f'How much does a {s["name"]} {s["permit"].lower()} cost?',
         f'The state charge is {"nothing — registration with the " + s["short"] + " is free" if s["fee"]=="$0" else s["fee"]}. Permits Clerk services start at $75; the full-service filing is $129 and includes application preparation, error checking, and filing support. {s["quirk"]}'),
    ...
    jsonld = ('<script type="application/ld+json">{"@context":"https://schema.org","@graph":['
      ...
      '{"@type":"Service","name":"%s Seller\'s Permit Filing Service","provider":{"@type":"Organization","name":"Permits Clerk","url":"https://www.permitsclerk.com/"},"areaServed":{"@type":"State","name":"%s"},"offers":{"@type":"Offer","price":"129.00","priceCurrency":"USD"}},'
    ...
    body = HEAD.format(
        ...
        meta=f'Get your {s["name"]} {s["permit"].lower()} fast. {("The state charges no fee" if s["fee"]=="$0" else "State fee: " + s["fee"])} — services start at $75; full-service filing is $129.',
        slug=slug, jsonld=jsonld, q=q)
    body += f"""
<section class="hero">
<h1>Get Your {e(s["name"])} {e(permit_label)} — Filed Fast, Done Right</h1>
<p class="lead">Businesses selling taxable goods in {e(s["name"])} must register for a {e(official)} with the {e(s["agency"])}. Answer a few simple questions — we prepare your application, check it for errors, and file it correctly. <strong>Services start at $75; full-service filing is $129.</strong></p>
...
<div class="fact"><strong>$129</strong><small>Full-service filing</small></div>
...
<div class="callout"><strong>Good to know:</strong> The {e(s["name"])} state charge is {e(fee_line)}. {e(s["quirk"])} Our $129 full-service filing covers guided preparation, an expert error check, filing support, and digital delivery of your documents. Other services start at $75.</div>
</section>
<section class="section">
<h2>How it works</h2>
<div class="steps">
...
<div class="cta-band">
<div><h2>Start your {e(s["name"])} application now.</h2><p>Services from $75 · full-service filing $129 · expert error check included</p></div>
...
<div class="callout" style="max-width:760px"><strong>Selling into other states?</strong> If your online store ships to customers in states that do charge sales tax, you may need seller’s permits there once you pass their thresholds. Services start at $75; full-service filing is $129 per state.</div>
...
idx = HEAD.format(title="Seller’s Permits by State — Requirements & Fees | Permits Clerk",
    meta="Seller’s permit requirements, state fees, and filing for all 50 states. Services start at $75; full-service filing is $129.",
    slug="states", jsonld="", q="")
idx += f"""
<section class="hero"><h1>Seller’s Permits by State</h1>
<p class="lead">Requirements, state fees, and issuing agencies for all 50 states — services start at $75, with full-service filing at $129.</p>
